    ...
    <div class="flex items-center justify-center min-h-screen p-4">
        ...
        <div class="w-full max-w-md space-y-8">
            ...
            <div class="bg-white p-8 rounded-2xl shadow-lg border border-gray-200">
                <!-- Session Error Alert dengan Alpine.js -->
                @if(session('error'))
                <div x-data="{ show: true }" x-init="setTimeout(() => show = false, 5000)" x-show="show" x-cloak
                    ...
                    <div>
                        <strong class="font-medium text-red-800">Gagal Login</strong>
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input type="email" name="email" id="email" 
                                   class="block w-full rounded-lg border-gray-300 p-3 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm border" 
